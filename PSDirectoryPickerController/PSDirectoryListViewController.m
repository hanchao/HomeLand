...
//    [newFolderButton release];
    ...
    UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleBordered target:[self navigationController] action:@selector(cancelButtonTapped)];
    ...
    UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:doneButtonTitle style:UIBarButtonItemStyleDone target:[self navigationController] action:@selector(cancelButtonTapped)];
