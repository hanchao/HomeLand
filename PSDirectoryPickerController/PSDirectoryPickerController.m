...
- (void)doneButtonTapped
{
    ...
    if ([[self delegate] respondsToSelector:@selector(directoryPickerController:didFinishPickingDirectoryAtPath:)]) {
        PSDirectoryPickerEntry *file = (PSDirectoryPickerEntry *)[visibleViewController.files objectAtIndex:visibleViewController.select];
        [[self delegate] directoryPickerController:self didFinishPickingDirectoryAtPath:file.path];
    }
}
